...
0
|| checktplrefresh('./template/zsk/common/header.htm', './template/default/common/header_common.htm', 1523519518, '7', './data/template/8_7_common_header_forum_index.tpl.php', './template/zsk', 'common/header_forum_index')
|| checktplrefresh('./template/zsk/common/header.htm', './template/default/common/header_qmenu.htm', 1523519518, '7', './data/template/8_7_common_header_forum_index.tpl.php', './template/zsk', 'common/header_forum_index')
|| checktplrefresh('./template/zsk/common/header.htm', './template/default/common/pubsearchform.htm', 1523519518, '7', './data/template/8_7_common_header_forum_index.tpl.php', './template/zsk', 'common/header_forum_index')
;?>
...
<?php } ?>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery-1.11.1.min.js" type="text/javascript"></script>
...
<div class="z"><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
                    <?php if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>
...
<?php } if(!empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onMouseOver="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">切换风格</a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?><div class="wic_header">
            <div class="wic_header_top cl">
                <div class="wp">
                    <?php $mnid = getcurrentnav();?>                    <div class="wic_logo z">
...
<?php } ?>                    </div>
            ...
            <div id="wic_hd" class="wic_header_bottom cl">
                <div class="wp">
                    ...
                    <a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})"><span>快捷导航</span></a>
                </div>
            </div>
