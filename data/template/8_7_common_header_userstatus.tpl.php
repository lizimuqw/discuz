...
<div id="um">
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" class="avt"><?php echo avatar($_G[uid],small);?></a>
<strong class="vwmy z<?php if($_G['setting']['connect']['allow'] && $_G['member']['conisbind']) { ?> qq<?php } ?>"><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="访问我的空间"><?php echo $_G['member']['username'];?></a></strong>
...
<?php } elseif(!$_G['connectguest']) { if(in_array('qqconnect',$_G['setting']['plugins']['available'])) { ?>
